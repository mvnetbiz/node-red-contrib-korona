module.exports = function (RED) {
  ...
  function CurrenciesAPI(config) {

    // Config SETUP
    RED.nodes.createNode(this, config);
    this.korona = config.korona;
    this.action = config.action;
    this.type = "Currencie"; // sorry, this spelling needs to be wrong! beause this string is used for forming the Method-Names CurrenciesApi() and getCurrencies().
  ...
  RED.nodes.registerType('Currencies', CurrenciesAPI);
};